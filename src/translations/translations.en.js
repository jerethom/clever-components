...
export const translations = {
  ...
  'cc-env-var-editor-expert.label': () => sanitize`Variable editor. Format: <code>VARIABLE_NAME="variable value"</code>. Every variable must be separated by a line break.`,
  //#endregion
  ...
  'cc-env-var-editor-json.label': () => sanitize`Variable editor. Format: <code>{ "name": "VARIABLE_NAME", "value": "variable value" }</code> <br> Array of objects following the above format`,
  //#endregion
