...
export const translations = {
  ...
  'cc-orga-member-card.error-edit': `Choose a new admin before you can demote this user.`,
  'cc-orga-member-card.error-remove': `Choose a new admin before you can remove or edit this user.`,
  'cc-orga-member-card.label-role': `Role`,
  'cc-orga-member-card.mfa-disabled': `disabled`,
  'cc-orga-member-card.mfa-enabled': `enabled`,
  ...
  'cc-orga-member-list.invite-error-duplicate': `This user is already a member of this organisation.`,
  'cc-orga-member-list.invite-error-empty': `You must enter an email address.`,
  'cc-orga-member-list.invite-error-format': () => sanitize`Invalid email address format.<br>Example: john.doe@example.com.`,
  'cc-orga-member-list.invite-format-email': `name@example.com`,
  ...
  'cc-orga-member-list.invite-label-email': `Email address`,
  'cc-orga-member-list.invite-label-role': `Role`,
