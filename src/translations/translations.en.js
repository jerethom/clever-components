...
export const translations = {
  ...
  'cc-ssh-key-list.add.info': () => sanitize`<p>You need to associate an SSH key to your account to deploy via Git: associate a key with the dedicated form.</p><p>Create an SSH key with the following command:</p><pre>ssh-keygen -t ed25519 -C "your@email.com"</pre>`,
  ...
  'cc-ssh-key-list.personal.info': () => sanitize`<p>This is the SSH keys associated with your account.</p><p>List the fingerprints of your keys with the following command:</p><pre>ssh-add -l -E sha256</pre>`,
  ...
  'cc-ssh-key-list.third-parties.import': `Import`,
