...
export const translations = {
  ...
  'cc-orga-member-card.error-edit': `Désignez un nouvel admin avant de pouvoir rétrograder cet utilisateur.`,
  'cc-orga-member-card.error-remove': `Désignez un nouvel admin avant de pouvoir supprimer ou modifier cet utilisateur.`,
  'cc-orga-member-card.label-role': `Rôle`,
  'cc-orga-member-card.mfa-disabled': `désactivée`,
  'cc-orga-member-card.mfa-enabled': `activée`,
  'cc-orga-member-card.mfa-label': `2FA`,
  ...
  'cc-orga-member-list.invite-error-duplicate': `Cet utilisateur fait déjà partie des membres de votre organisation.`,
  'cc-orga-member-list.invite-error-empty': `Veuillez saisir une adresse e-mail.`,
  'cc-orga-member-list.invite-error-format': () => sanitize`Format d'adresse e-mail invalide.<br>Exemple: john.doe@example.com.`,
  'cc-orga-member-list.invite-format-email': `nom@example.com`,
  ...
  'cc-orga-member-list.invite-label-email': `Adresse e-mail`,
  'cc-orga-member-list.invite-label-role': `Rôle`,
  'cc-orga-member-list.invite-role-accounting': `Comptable`,
  'cc-orga-member-list.invite-role-admin': `Admin`,
  'cc-orga-member-list.invite-role-developer': `Developpeur`,
  'cc-orga-member-list.invite-role-manager': `Manager`,
  'cc-orga-member-list.invite-submit': `Inviter`,
  'cc-orga-member-list.invite-submit-error': ({ userEmail }) => `Une erreur est survenue lors de l'invitation de ${userEmail} dans l'organisation.`,
