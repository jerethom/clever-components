...
/**
 * @typedef {import('./types.js').ToastPosition} ToastPosition
 * @typedef {import('./types.js').ToastAnimation} ToastAnimation
 * @typedef {import('./types.js').Notification} Notification
 * @typedef {import('./types.js').ToastOptions} ToastOptions
