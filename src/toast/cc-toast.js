...
/**
 * @typedef {import('./types.js').NotificationIntent} NotificationIntent
 */
 ...
 * * Optionally, it can be closed manually with a close button.
 ...
 *
 * The `message` property can be a simple string, but you can also pass a DOM `Node`.
 *
 * ## Technical details
 *
