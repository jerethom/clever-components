...
/**
 * @typedef {import('./cc-addon-jenkins-options.types.d.ts').Option} Option
 */
 ...
 * @cssdisplay block
 *
 * @event {CustomEvent<GenericOptions>} cc-addon-jenkins-options:submit - Fires when the form is submitted.
 */
