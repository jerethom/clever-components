 ...
 * @typedef {import('./cc-test-component.types.js').TupleFoo} TupleFoo
 * @typedef {import('./cc-test-component.types.js').TupleBar} TupleBar
 * @tyedef {import('./cc-test-component.types.js').TupleBar} TupleBar
